        ...
        <div className="flex flex-col h-full bg-transparent relative overflow-hidden p-6">
            ...
            <div className="glass-card mb-6 h-20 flex items-center justify-between px-6 z-10 shrink-0">
                <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1 font-medium">Share your wins, screenshots, and daily updates.</p>
                </div>
                ...
                <div className="max-w-2xl mx-auto flex flex-col gap-6">
                    {updates.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-32 text-slate-400 text-center animate-fade-in-up">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-2">No progress shared yet</h3>
                            <p className="text-slate-400 max-w-sm">Inspire your group! Be the first to share your recent wins or study screenshots.</p>
